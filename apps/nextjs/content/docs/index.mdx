...
I'm going to use this to document all the features of MyCartage and how they are built. The documentation site is built using [ContentLayer](/docs/documentation/contentlayer) and MDX.
