      ...
      >
        <defs>
          <pattern id={id} width="6" height="8" patternUnits="userSpaceOnUse">
            <path
              d="M0 0H6M0 8H6"
              className="stroke-slate-400/10 dark:stroke-white/10 xl:stroke-zinc-100/10"
              fill="none"
            />
          </pattern>
        </defs>
...
function Glow() {
  ...
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden bg-gray-950 lg:right-[calc(max(2rem,50%-38rem)+40rem)] lg:min-w-[32rem]">
      ...
      <div className="absolute inset-x-0 bottom-0 right-0 h-px bg-zinc-50 mix-blend-overlay lg:left-auto lg:top-0 lg:h-auto lg:w-px" />
    </div>
  );
}
