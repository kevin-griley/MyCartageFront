...
import screenshotInventory from "~/images/screenshots/Rate_Map.png";
import screenshotInventory2 from "~/images/screenshots/Rate_Table.png";
  ...
  return (
    <div className="relative isolate overflow-hidden bg-gray-50 px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
      ...
      >
        ...
        <div className="-ml-12 -mt-12 lg:sticky  lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:-mb-36 lg:overflow-hidden">
          <Image
            className="w-[48rem] max-w-none rounded-xl sm:w-[57rem]"
            src={screenshotInventory2}
            alt="Collaboration"
            quality={100}
          />
          <Image
