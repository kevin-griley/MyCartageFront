        ...
        <div className="mx-auto max-w-md sm:text-center">
          ...
          <div className="mt-8 flex justify-center">
            <Link
              ...
              className="inline-flex h-10 items-center justify-center rounded-md bg-zinc-50 px-4 py-2 text-sm font-medium text-slate-900 transition-colors hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 "
            >
